...
make %BASE_PARAMS% BUILD_DIR=_UltimakerMarlin_250000 VERSION_PROFILE="250000 single"
make %BASE_PARAMS% BUILD_DIR=_UltimakerMarlin_115200 VERSION_PROFILE="115200 single"
make %BASE_PARAMS% BUILD_DIR=_UltimakerMarlin_Dual_250000 VERSION_PROFILE="250000 dual" TEMP_SENSOR_1=-1 EXTRUDERS=2
make %BASE_PARAMS% BUILD_DIR=_UltimakerMarlin_Dual_115200 VERSION_PROFILE="115200 dual" TEMP_SENSOR_1=-1 EXTRUDERS=2
